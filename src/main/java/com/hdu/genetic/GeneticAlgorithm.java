...
public class GeneticAlgorithm {
    ...
    private void createBeginningSpecies(SpeciesPopulation list) {
        //100%随机
        int randomNum = TSPData.SPECIES_NUM;
...
//			}
     ...
     * @param list 初始种群
     */
    private void calRate(SpeciesPopulation list) {
        //计算总适应度
     ...
     * @param list 种群
     */
    private void select(SpeciesPopulation list) {
        //计算适应度
        calRate(list);
    ...
    //获得适应度最大的物种
    private SpeciesIndividual getBest(SpeciesPopulation list) {
